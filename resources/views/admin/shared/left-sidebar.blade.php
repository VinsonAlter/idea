<div class="card overflow-hidden">
    <div class="card-body pt-3">
        <ul class="nav nav-link-secondary flex-column fw-bold gap-2">
            ...
            <li class="nav-item">
                <a class="{{Route::is('admin.users.index') ? 'text-white bg-primary rounded' : ''}} nav-link text-dark" href="{{route('admin.ideas.index')}}">
                    <span>Ideas</span></a>
            </li>
        </ul>
    </div>
    <div class="card-footer text-center py-2">
        ...
        <a class="btn btn-link btn-sm" href="{{route('lang', 'id')}}">ID</a>
    </div>
</div>